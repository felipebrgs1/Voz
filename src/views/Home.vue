<template>
  <div class="min-h-screen flex flex-col">
    <div class="relative flex-1">
      <div id="home" class="h-screen w-full bg-cover bg-center flex items-center justify-center fixed-bg"
    ...
    <section class="min-h-screen bg-gray-100 p-4 md:p-8 content-center">
      <div class="max-w-6xl mx-auto">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-20">
          <Card v-for="(item, index) in limitedCars" :key="index" :project="item" />
        </div>
      </div>
    </section>

    <div class="h-screen w-full bg-cover bg-center fixed-bg relative" style="background-image: url('CarroF.png');">
        ...
        <div class="w-full md:w-1/2 h-full flex flex-col items-center justify-center relative">
          ...
          <div class="relative z-10 max-w-xl space-y-6 p-4 w-10/12">
            ...
            <div class="flex justify-center md:justify-end">
              <a href="/Tabela">
                <button type="button" class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 
                  focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm md:text-base px-6 py-3 
...
.blur-background {
  background: linear-gradient(270deg, rgba(29, 37, 39, 0.6) 0%,
